# Prompt — Gerar ADR (Claude.ai)

> Roda no Claude.ai. Escreve um ADR a partir do template. Cole o bloco abaixo, preenchendo os `[campos]`.

```text
Pela lente de Tech Lead, escreva um ADR usando o template docs/templates/adr.md para a decisão: [DECISÃO].
