...
Leia o épico @docs/epicos/<release>.md e os ADRs/RFCs relacionados em @docs/adr/ e @docs/rfc/.
...
Depois que eu aprovar: crie as cascas de Story no board (GitHub Projects, via gh CLI), em Backlog, com o prefixo numérico que liga ao épico. Não escreva Specs — elas vêm uma por vez, depois.
```
